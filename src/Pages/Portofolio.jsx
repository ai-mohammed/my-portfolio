...
// Mini twitter project using SQL database
const projects = [
  {
    id: 1,
  Title: "ChainEats",
  ...
  return (
    <div className="md:px-[10%] px-[5%] w-full sm:mt-0 mt-[3rem] bg-[#030014] overflow-hidden" id="Portofolio">
      ...
      <div className="text-center pb-10" data-aos="fade-up" data-aos-duration="1000">
        <h2 className="inline-block text-3xl md:text-5xl font-bold text-center mx-auto text-transparent bg-clip-text bg-gradient-to-r from-[#0ea5e9] to-[#3b82f6]">
          <span style={{
            color: '#0ea5e9',
            backgroundImage: 'linear-gradient(45deg, #0ea5e9 10%, #3b82f6 93%)',
        ...
        <p className="text-slate-400 max-w-2xl mx-auto text-sm md:text-base mt-2">
          Explore my journey through projects, certifications & Awards, and technical expertise. 
        ...
        <AppBar
          ...
          sx={{
            ...
            "&::before": {
              ...
              right: 0,
              bottom: 0,
              background: "linear-gradient(180deg, rgba(14, 165, 233, 0.03) 0%, rgba(59, 130, 246, 0.03) 100%)",
